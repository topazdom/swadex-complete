        ...
        {showLists ? (
          <Fragment>
            <input
              ...
              className="w-full p-3 mb-2 rounded-md outline-0 text-sm"
            />
            <TokenList />
          </Fragment>
        ) : (
          <Fragment>
            ...
            <p className="bg-white p-2 rounded-md text-[12px] absolute bottom-6 text-center w-11/12 mx-auto font-medium">
