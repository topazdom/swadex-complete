      ...
      >
        ...
        <div>
          ...
          <div className="text-center px-2 py-4 mt-4 rounded-md bg-white">
            <ReportProblemOutlinedIcon style={{fontSize: "54px"}} className="text-orange-500 text-center mb-6 mx-auto block" />
            <h3 className="text-orange-500 font-medium block">
              Trade at your own risk!
            </h3>
            <p className="text-gray-500 leading-6 mt-3">
              Anyone can create a token, including creating a fake
              version of existing token that claims to represent projects.
            ...
            /> 
            <span className="text-[14px] text-[#090A0B] leading-5 ml-2">I understand</span>
          </label>
          </div>
        </div>
