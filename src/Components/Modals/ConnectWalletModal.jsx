...
function ConnectWalletModal({ setShowConnectWallet }) {
  ...
  return (
    <motion.div 
      className="w-screen h-screen absolute inset-0 bg-[#50505099] flex items-center justify-center z-10"
      animate={{opacity: 1}}
      transition={{duration: 2}}
      exit={{opacity: 0}}
    >
      <motion.div 
        className="p-4 bg-[#F8F8F9B2] w-11/12 max-w-[364px] z-20 h-[445px]"
      ...
      >
        ...
        <div>
          <div
            className="cursor-pointer p-2 rounded-md border-[1px] border-black bg-white flex items-center justify-between"
            onClick={() => navigate("/login/cryptooly")}
          >
        ...
        <div className="py-2 flex items-center gap-2 pt-4">
          ...
          <a href="/" className="text-[#016E89] text-[14px] underline">
