  ...
  return (
    <div className="bg-[#F8F8F9]">
      <div className="container h-[80px] mx-auto px-6 lg:px-12 flex items-center relative">
        ...
        {showNotification && <div className="absolute bg-[#CDF9D0] rounded-md p-4 right-6 top-[90px] z-30">
      ...
      {showMobileNav && <div className='absolute h-screen w-screen bg-black inset-0 z-20 bg-opacity-20 lg:hidden'>
        <div className="absolute right-0 top-0 bg-white w-[379px] h-full pt-4">
